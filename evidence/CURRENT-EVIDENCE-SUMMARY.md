...
- Evidence base includes a recent meta-analysis of small RCTs suggesting improved healing endpoints overall, but trials are heterogeneous and often small.
- In well-nourished patients with uncomplicated acute surgical wounds, speed-of-closure benefits are inconsistent; some studies suggest infection/colonization improvements more than faster closure.
- **⚠️Risks/cautions:** Chronic/high dosing (commonly ≥50 mg/day for many weeks) can cause copper deficiency (anemia/neutropenia); GI upset is possible. Separate dosing from quinolones/tetracyclines to avoid absorption issues.
...
- Nerve recovery: mixed—one non-randomized positive signal in a specific neuro-rehab combination, but a double-blind RCT in knee arthroplasty showed no benefit for incision numbness with methylcobalamin.
- Folate and chronic ulcers: some supportive controlled/observational data in diabetic/venous ulcers, but not directly generalizable to acute surgical incisions.
- No RCTs demonstrating that methylfolate or methylcobalamin improves general surgical wound healing or speeds overall recovery in otherwise replete patients.
- **⚠️Risks/cautions:** Generally low; key practical risk is masking B12 deficiency with high folate (less relevant if B12 status is ensured). Main perioperative concern is unrecognized B12 deficiency + N₂O exposure (harm from deficiency, not the supplement).
...
- Withdrawal headache prevention in habitual users: perioperative caffeine (including IV caffeine in PACU) reduces headache incidence in RCT data.
- Reduced facial swelling: limited to a single dental implant RCT using an acetaminophen+caffeine combination vs acetaminophen+codeine.
- Anesthesia emergence / alertness: suggestive but not definitive; confounded observational data.
- No direct evidence facial plastic surgeries for improved wound healing or reduced bruising.
- **⚠️Risks/cautions:** No consistent clinical signal of harm at moderate intake in studies, but plausible perioperative issues include transient BP/HR increases, dehydration if fluid intake is poor, and lab (non-clinical) evidence suggesting impaired epithelialization at high exposures. Practical implication: moderation + hydration, and defer to surgeon-specific restrictions in high-bleeding-risk facial cases.
...
- Swelling/edema outcomes are mixed across meta-analyses; some show benefit at 2–3 days and 7 days post-op, while others do not. Variation may reflect measurement techniques and procedure type.
- Trismus outcomes are mixed/inconclusive: some reviews suggest improvement in mouth opening, while others find no significant effect by day 7; depends on included trials and measurement methods.
- **⚠️Risks/cautions:** Biologic anticoagulant/antiplatelet effects (ex vivo PT prolongation up to 47%; platelet aggregation inhibition ~19%) raise a plausible hematoma/bleeding risk, especially with anticoagulants/antiplatelets or in bleeding-prone patients. Practical implication: many periop protocols conservatively recommend stopping 10–14 days pre-op; any "pre-loading" strategy should be surgeon-directed.
...
- Direct evidence for reducing bruising in elective surgery is limited; the rationale is strongest for patients with suboptimal intake or higher tissue-repair demands.
...
- Strong preclinical (animal) evidence for protection in ischemia–reperfusion injury models, but translation to routine elective surgery remains uncertain.
- No robust clinical evidence supporting routine pre-op astaxanthin to improve healing, pain, swelling, or complication rates across surgeries.
- **⚠️Risks/cautions:** Bleeding/anticoagulant concern: animal data show prolonged clotting times and reduced platelet aggregation; plus a warfarin interaction case report with extreme INR elevation and bruising. Practical implication: avoid perioperatively unless surgeon/anesthesia explicitly agree, and avoid particularly with anticoagulants/antiplatelets.
...
- No direct trials in facial plastic surgery/FFS (or in elective surgical recovery broadly) demonstrating clinically meaningful benefit; randomized perioperative trials are limited/ongoing.
- Practical interpretation: At present, BPC-157 remains an experimental candidate with impressive preclinical breadth but insufficient human perioperative efficacy evidence to recommend routine use as a “recovery accelerator.”
- **⚠️Risks/cautions:** Regulatory/quality risk is central (not FDA-approved; access often via unregulated “research” supply with contamination/mislabelling risk; compounding restrictions). Safety data in humans are limited by small sample sizes and short follow-up. Theoretical concerns include pro-angiogenic effects (uncertain implications in patients with active/occult malignancy) and unknown interactions with perioperative medications. Use (if considered at all) should be surgeon/anesthesia-directed and avoided when product quality and medical oversight cannot be assured.
...
- Transfeminine-specific sleep data are limited and not clearly positive (small prospective controlled study showed no significant sleep benefit at 100 mg).
- Mechanistic/animal wound-healing rationale exists but is not validated in human surgical trials.
- Sodium/fluid effects are plausible (antimineralocorticoid activity) but unproven postoperatively.
- Large trauma trials (TBI) show no recovery benefit in a major-injury context.
- **⚠️Risks/cautions:** IV progesterone in TBI trials increased thrombophlebitis (likely formulation-related), reminding that progesterone is not risk-free in acute care contexts. Any hormone use post-op requires attention to VTE risk in the perioperative period (context-dependent). Sedation/dizziness can be clinically relevant.

## 🔴 Evidence of Harm with Use
...
- No clinical trials showing keto/very-low-carb improves postoperative bruising, swelling, wound healing, or recovery in surgery (including FFS).
- **⚠️Risks/cautions:** Evidence of perioperative risk signals: ketosis associated with metabolic acidosis in fasted surgical patients; pediatric keto anesthesia experience includes clinically significant acidosis requiring treatment; potential hypoglycemia/electrolyte challenges; and observational evidence of platelet function changes/bruising in some keto patients. Clinical implication: avoid intentional perioperative ketosis unless medically indicated and managed by the surgical/anesthesia team; follow ERAS-style nutrition when appropriate.
...
- Observational associations link low vitamin D with poorer orthopedic outcomes, but intervention trials for “boosting healing” are largely negative.
- High-dose or bolus vitamin D does not reliably improve fracture union/healing in RCTs and systematic reviews; no evidence in craniofacial/FFS osteotomies.
- **⚠️Risks/cautions:** High-dose/bolus regimens can be harmful: RCT signal of worsened bone microarchitecture in one distal radius fracture trial; known toxicity risk (hypercalcemia) with excessive dosing; large intermittent doses linked to increased falls/fractures in other populations. Clinical implication: aim for sufficiency, avoid mega-dosing unless medically indicated and monitored.
